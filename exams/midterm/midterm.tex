...
\hypersetup{
  pdftitle={DATA 5690: Midterm Exam},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\section*{\texorpdfstring{\textbf{Frequentist
Analysis}}{Frequentist Analysis}}\label{frequentist-analysis}
\addcontentsline{toc}{section}{\textbf{Frequentist Analysis}}
